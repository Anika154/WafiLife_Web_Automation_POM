...
//
//        homePage.clickOnElement(homePage.nextPage);
//        homePage.clickOnElement(homePage.selectAuthor);
//        homePage.clickOnElement(homePage.bookDetails);
        homePage.clickOnElement(homePage.orderBtn);
        homePage.clickOnElement(homePage.completeOrderBtn);
